...
def is_runon_entry(current_entry, previous_entry):
    ...
    """
    prompt = f"""Analysis task: Is this a valid dictionary entry or a run-on fragment?

VALID entries start with EITHER:
1. Chinese characters + romanization (e.g. "挨 (rad.64) āi")
2. Romanization + Chinese characters (e.g. "āi shēn pào 挨身炮")

RUN-ON fragments do NOT start with above patterns and continue the previous entry.

Previous: "{previous_entry}"
Current: "{current_entry}"

Is current entry a run-on fragment? Answer YES or NO."""
